 ...
 * @version 1.0.0
 */
$apiEndpoint = 'http://tcgweb16931.pperfect.com/ecomService/v18/Json/';
...
$curlControllers = [
    ...
    'api-pp-set-collection' => new CurlController($apiEndpoint . '?class=Collection&method=quoteToCollection'),
];
